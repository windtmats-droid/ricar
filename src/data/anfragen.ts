...
export const SAMPLE_ANFRAGEN: Anfrage[] = [
  {
    ...
    fahrzeugId: "s1",
    preview: "Ist das Fahrzeug noch verfügbar? Ich würde es gerne...",
    fullMessage: "Guten Tag, ist das Fahrzeug noch verfügbar? Ich würde es sehr gerne besichtigen und bin zeitlich flexibel. Haben Sie diese Woche noch Termine frei?\n\nMit freundlichen Grüßen,\nKlaus Weber",
