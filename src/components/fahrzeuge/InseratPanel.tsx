            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="text-xs text-muted-foreground">AutoScout24 listen</span>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="text-xs text-muted-foreground">Mobile.de listen</span>
                  <Badge variant="secondary" className="text-[9px] px-1.5 py-0">Bald verfügbar</Badge>
                </div>
                <Switch disabled className="opacity-40" />
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="text-xs text-muted-foreground">Social Media Post</span>
                  <Badge variant="secondary" className="text-[9px] px-1.5 py-0">Bald verfügbar</Badge>
                </div>
                <Switch disabled className="opacity-40" />
              </div>
