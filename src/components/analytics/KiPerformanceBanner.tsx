export function KiPerformanceBanner() {
  return (
    <div className="rounded-xl p-4 px-5 text-primary-foreground" <div className="rounded-xl p-4 px-5 text-primary-foreground" style={{ background: "linear-gradient(135deg, var(--accent-from, #2563eb), var(--accent-to, #1e40af))" }}>>
